...
const SLIDES = [
  ...
  },
  {
    ...
    description:
      " Menu Maker is a web application designed to help restaurant owners create, customize, and publish their menus quickly and intuitively. As the Front-End Developer at Webgencia, you were entrusted with preparing the entire project plan while the Product Owner was on medical leave including the technical specifications and the Agile structuring. This project demonstrates your ability not only to code, but also to handle full project preparation, planning, and documentation like in a real-world agency environment.",

    context:
      "The client, Qwenta, requested a tool allowing restaurant owners to design and publish their menus in just a few clicks. The Product Owner, Soufiane, provided initial materials (mockups + functional specs) before taking sick leave. During his absence, i was fully responsible for: Structuring the project. Writing the 15-page Technical Specification Document. Building a complete Agile Kanban board. Organizing a technology watch. Also prepared the slide deck that the PO would later present to the client.",
  ...
  },
  {
    ...
    context:
      "Print it needed to bring more life to its website to better showcase its printing services. Lucien, the company director, contacted me with a detailed video explaining the exact behavior he expected from the carousel: smooth transitions, clear navigation, and clean visuals. My mission was to design and implement this carousel from scratch, ensuring it blended seamlessly into the existing website while improving usability and visual appeal.",
  ...
  },
  {
    ...
    context:
      "On Monday morning, the team brief outlined all essential project details. Charlotte, the project manager, provided the Figma design, the back-end API code, the original static front-end, and the Kanban board with assigned tasks. I was responsible for transforming the static architect portfolio into a dynamic and interactive interface. My three main missions were: developing the architect’s gallery page, creating the admin login page from scratch, and building a modal allowing authenticated users to upload new media. With all assets and codebases provided, I was ready to begin the development work.",
